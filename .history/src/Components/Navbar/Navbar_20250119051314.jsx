...
<nav classNameName="navbar navbar-expand-lg bg-dark text-white ">
<div className="container">
    <a href="#" className="navbar-brand text-white ">Voting App</a>

    
    <button className="navbar-toggler" data-bs-target="#navmenu" data-bs-toggle="collapse">
    ...
    <div className="collapse navbar-collapse " id="navmenu">
        <ul className="navbar-nav ms-auto text-center">
            ...
            <a href="./Login.html"  className="nav-link btn btn-primary text-white">Login</a>
        </ul>
    </div>
</div>
</nav>
