    ...
    <>
      <div className="row hero ">
        ...
        <div className="col-md  align-items-center h-100 bg-black text-light">
          <form
            action="#"
            className="w-100 bg-secondary p-5 m-auto col-lg-8 gap-5"
          >
            <h1>Register</h1>
            <label className="col-sm form-label ">
              Name <br />
            </label>
            <input className="form-control form-text w-100" type="text" />

            <label className="form-label col-sm m-3">
              Date Of Birth <br />
            </label>
            ...
            <label className="m-3 form-label col-sm ">
              Email <br />
            </label>
