...
<footer className="row text-light bg p-5" >
  ...
  <div className="newsletter col-md">
    ...
    <htmlForm action="" className="">
        ...
        <label htmlFor="feedback">Name <br/>
            <input type="text" className="htmlForm-control"/>
        </label> 
        <br/>
        <label htmlFor="textarea">Feedback <br/>
            <textarea name="newsletter" id="" className="htmlForm-control w-100" width="500px"></textarea>
        </label>  <br/>
